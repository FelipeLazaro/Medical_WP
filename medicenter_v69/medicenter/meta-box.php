...
function theme_save_postdata($post_id) 
{
	...
	if(isset($_POST["page_sidebar_header"]) && isset($_POST["page_sidebar_top"]) && isset($_POST["page_sidebar_right"]) && isset($_POST["page_sidebar_footer_top"]) && isset($_POST["page_sidebar_footer_bottom"]))
