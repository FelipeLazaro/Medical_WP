...
class home_box_widget extends WP_Widget 
{
	...
	{	
		global $themename;
		$title = isset($new_instance['title']) ? esc_attr($instance['title']) : "";
		$title_color = isset($new_instance['title_color']) ? esc_attr($instance['title_color']) : "";
		$color = isset($new_instance['color']) ? esc_attr($instance['color']) : "";
		$custom_color = isset($new_instance['custom_color']) ? esc_attr($instance['custom_color']) : "";
		$width = isset($new_instance['title']) ? (int)($instance['width']) : "";
		$content = isset($instance['content']) ? $instance['content'] : "";
		$text_color = isset($new_instance['text_color']) ? esc_attr($instance['text_color']) : "";
		$more_button_url = isset($new_instance['more_button_url']) ? esc_attr($instance['more_button_url']) : "";
		$more_button_label = isset($new_instance['more_button_label']) ? esc_attr($instance['more_button_label']) : "";
		$button_target = isset($new_instance['button_target']) ? esc_attr($instance['button_target']) : "";
		$button_text_color = isset($new_instance['button_text_color']) ? esc_attr($instance['button_text_color']) : "";
		$button_hover_text_color = isset($new_instance['button_hover_text_color']) ? esc_attr($instance['button_hover_text_color']) : "";
		$button_color = isset($new_instance['button_color']) ? esc_attr($instance['button_color']) : "";
		$button_custom_color = isset($new_instance['button_custom_color']) ? esc_attr($instance['button_custom_color']) : "";
		$button_hover_color = isset($new_instance['button_hover_color']) ? esc_attr($instance['button_hover_color']) : "";
		$button_custom_hover_color = isset($new_instance['button_custom_hover_color']) ? esc_attr($instance['button_custom_hover_color']) : "";
		$animation = isset($new_instance['animation']) ? esc_attr($instance['animation']) : "";
		$animation_duration = isset($new_instance['animation_duration']) ? esc_attr($instance['animation_duration']) : "";
		$animation_delay = isset($new_instance['animation_delay']) ? esc_attr($instance['animation_delay']) : "";
		?>
		<p>
